...
plt.rcParams['font.family'] = 'NanumGothic'  # 설치한 폰트 이름
...
def visualize_continuous_with_target(df, cols_to_visualize, bins=None, figure_size=(12, 6), target_column='임신 성공 확률'):
    """
...
def visualize_with_target(df, cols_to_visualize, threshold=10, figure_size=(12, 6), target_column='임신 성공 확률'):
